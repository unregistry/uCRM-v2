...
function sugar_chown($filename, $user = '')
{
    if (!is_windows()) {
        if (strlen($user)) {
            ...
            if (isset($GLOBALS['sugar_config']['default_permissions']['user']) &&
                !is_array($GLOBALS['sugar_config']['default_permissions']['user']) &&
                strlen((string) $GLOBALS['sugar_config']['default_permissions']['user'])) {
...
function sugar_chgrp($filename, $group = '')
{
    if (!is_windows()) {
        if (!empty($group)) {
            ...
            if (isset($GLOBALS['sugar_config']['default_permissions']['group']) &&
                !is_array($GLOBALS['sugar_config']['default_permissions']['group']) &&
                !empty($GLOBALS['sugar_config']['default_permissions']['group'])) {
